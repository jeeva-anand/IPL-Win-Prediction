...
pipe = pkl.load(open('./pickle.pkl','rb'))
...
with col1:
  over = int(st.number_input('Over completed',step=1))

with col1:
  wicket = int(st.number_input('wicket fallen',step=1))
...
elif wicket==10 and score < target-1:
